...
const SHOP_DATA = {
    ...
    EFFECTS: [
        ...
        { id: 'drones', name: { sr: 'Svetleći Dronovi', en: 'Drone Show' }, price: 25000, desc: { sr: 'Zatamnjuje nebo, pali reflektore i ispisuje TVOJE IME u 3D hologramu uz epski zvuk (V.2).', en: 'Dims the sky, turns on spotlights and spells YOUR NAME in a 3D hologram with epic sound (V.2).' }, duration: '8s', category: { sr: '⚡ SPEKTAKL & ZABAVA', en: '⚡ SPECTACLE & FUN' }, cssClass: 'prev-drones', innerHtml: '' },
        ...
        { id: 'royal_yamb', name: { sr: 'Kraljevski Yamb', en: 'Royal Yamb' }, price: 60000, desc: { sr: 'Kruna, zlatni reflektori, YAMB natpis i pljusak dukata za šampionsko finale.', en: 'A crown, golden spotlights, YAMB title and coin burst for a champion finale.' }, duration: '8s', category: { sr: '⚡ SPEKTAKL & ZABAVA', en: '⚡ SPECTACLE & FUN' }, cssClass: 'prev-royal-yamb', innerHtml: '<div class="royal-yamb-crown"></div><div class="royal-yamb-title">YAMB</div>' }
    ],

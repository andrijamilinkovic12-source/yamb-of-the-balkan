...
const SHOP_DATA = {
    ...
    EFFECTS: [
        ...
        { id: 'drones', name: { sr: 'Svetleći Dronovi', en: 'Drone Show' }, price: 25000, desc: { sr: 'Zatamnjuje nebo i ispaljuje dronove koji ispisuju VAŠE IME u obliku holograma na 8 sekundi.', en: 'Dims the sky and deploys drones that spell YOUR NAME as a hologram for 8 seconds.' }, duration: '8s', category: { sr: '⚡ SPEKTAKL & ZABAVA', en: '⚡ SPECTACLE & FUN' }, cssClass: 'prev-drones', innerHtml: '' }
    ],

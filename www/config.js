...
const SHOP_DATA = {
    ...
    EFFECTS: [
        ...
        { id: 'balkan', name: { sr: 'Svadba', en: 'Wedding' }, price: 25000, desc: { sr: 'Kafanski stolnjak, 4 trube, kiša para i proceduralno Užičko kolo (V.2).', en: 'Kafana tablecloth, 4 trumpets, money rain and fast folk music (V.2).' }, duration: '7s', category: { sr: '⚡ SPEKTAKL & ZABAVA', en: '⚡ SPECTACLE & FUN' }, cssClass: 'prev-balkan', innerHtml: '' },

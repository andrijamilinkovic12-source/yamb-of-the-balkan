...
const SHOP_DATA = {
    ...
    EFFECTS: [
        ...
        { id: 'royal_yamb', name: { sr: 'Kraljevski Yamb', en: 'Royal Yamb' }, price: 0, desc: { sr: 'Kruna, zlatni reflektori, YAMB natpis i pljusak dukata za šampionsko finale.', en: 'A crown, golden spotlights, YAMB title and coin burst for a champion finale.' }, duration: '7s', category: { sr: '⚡ SPEKTAKL & ZABAVA', en: '⚡ SPECTACLE & FUN' }, cssClass: 'prev-royal-yamb', innerHtml: '<div class="royal-yamb-crown"></div><div class="royal-yamb-title">YAMB</div>' }
    ],

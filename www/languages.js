...
const TRANSLATIONS = {
    sr: {
        ...
        "push_channel_name": "Yamb obaveštenja",
        "push_channel_desc": "Obaveštenja za turnire, rekorde i Kvartalnu ligu",
        "push_open_prompt": "Otvori obaveštenje?",
        "push_open": "Otvori",
        "push_later": "Kasnije",
        ...
        "league_champion_title": "ŠAMPION KVARTALNE LIGE",
        ...
        "shop_watch_to_unlock": "Gledaj 📺 za otključavanje",
        "theme_unlock_success": "Tema je uspešno otključana!",
        ...
        "local_game_sync_required": "Partija ne može da počne dok server ne potvrdi bezbedno čuvanje rezultata. Proverite internet vezu i pokušajte ponovo.",
        ...
        "aria_close_h2h": "Zatvori H2H statistiku",
        "aria_close_power_index": "Zatvori listu Indeksa moći",
        "aria_close_streak": "Zatvori listu Vatrenog niza",
        "economy_tabs_aria": "Opcije dukata i vraćanja upisa",
        "treasury_tabs_aria": "Kategorije riznice",
        ...
        "err_spectate_already_in_game": "Već ste u online partiji. Za gledanje tuđe partije otvorite nalog koji nije učesnik tog meča.",
        "err_spectate_open_failed": "Ne mogu da otvorim gledanje ove partije. Osvežite online listu i probajte ponovo.",
        ...
        "err_matchmaking_busy": "Već imate aktivnu online partiju ili oporavak prethodnog duela. Vratite se u taj duel ili izađite iz njega pre nove pretrage.",
        ...
        "stat_h2h_title": "MEĐUSOBNI DUELI",
        ...
        "game_roll": "BACAJ",
        "game_wait": "SAČEKAJ...",
        "game_returning": "Vraćanje u igru...",
        "game_write": "UPIŠI",
        ...
        "global_chat_loading": "Učitavam poruke...",
        "global_chat_empty": "Još nema poruka. Započnite razgovor.",
        ...
        "go_title_solo_rough": "NIJE BIO TVOJ DAN",
        "go_title_solo_more": "IMA PROSTORA ZA VIŠE",
        "go_title_solo_progress": "LEP NAPREDAK",
        "go_title_solo_good": "DOBRA PARTIJA",
        "go_title_solo_masterful": "MAJSTORSKA PARTIJA",
        "go_title_solo_perfect": "SAVRŠENSTVO",
        "go_msg_win": "Pobednik je",
        "go_msg_solo": "OSVOJENI POENI",
        "go_personal_best": "LIČNI REKORD",
        "go_label_your_score": "TVOJ REZULTAT",
        "go_best_column": "NAJJAČA KOLONA",
        "go_no_zero": "BEZ NULE",
        "go_yes": "DA",
        "go_no": "NE",
        "go_msg_solo_good": "Završio si partiju sa {0} poena. Sledeća može bolje.",
        "go_msg_solo_great": "Sjajna partija! Osvojio si {0} poena.",
        "go_msg_solo_rough": "Ovaj put nije išlo kako si hteo. Sledeća tabla je nova prilika — {0} poena.",
        "go_msg_solo_more": "Solidan početak, ali znaš da možeš više. Rezultat: {0} poena.",
        "go_msg_solo_progress": "Vidi se pomak. Nastavi ovako — {0} poena.",
        "go_msg_solo_good": "Stabilna i dobra igra. Osvojio si {0} poena.",
        "go_msg_solo_masterful": "Odlična kontrola table — {0} poena.",
        "go_msg_solo_perfect": "Vrhunska partija. {0} poena — za pamćenje.",
        ...
        "go_double_easter": "DUPLIRAJ NAGRADU (x2)",
        "go_claim": "Preuzmi i Izađi",
        "go_rematch": "🔄 REVANŠ",
        "msg_reward_doubled": "Uspešno ste duplirali nagradu!\nUkupno osvojeno:",
        "reward_claim_retry": "Nagrada još nije potvrđena. Pokušajte ponovo za par sekundi.",
        "ad_confirmation_retry": "Potvrda reklame još nije stigla. Pokušajte preuzimanje nagrade za par sekundi.",
        ...
        "undo_expired": "Vraćanje tog upisa više nije dostupno jer je sledeći potez započet.",
        "undo_unavailable": "Vraćanje upisa trenutno nije dostupno.",
        "undo_menu_desc": "Nabavi tokene za vraćanje poteza",
        "undo_btn_ad_1": "Gledaj nagradni video (+1)",
        ...
        "rules_goal_text": "Cilj je osvojiti što više poena bacanjem 6 kockica i upisivanjem najboljih kombinacija u tabelu. U svakom potezu imate do 3 bacanja, a posle svakog bacanja možete zadržati kockice koje želite da sačuvate.",
        ...
        "rules_col_man": "<strong>RUČNO (R):</strong> Boduje se samo posle prvog bacanja. Ako nastavite, polje se upisuje kao 0 nakon potvrde.",
        "rules_col_ann": "<strong>NAJAVA (📢):</strong> Posle prvog bacanja možete uključiti Najavu, izabrati tačno polje i zatim morate upisati baš to polje.",
        ...
        "rules_sec2_text": "Formula: (Max - Min) * broj jedinica. Ako je rezultat ≥ 60, bonus je +40. Ako je MIN 0 ili je obračun negativan, sekcija vredi 0.",
        "rules_sec3_title": "3. SEKCIJA (KOMBINACIJE)",
        "rules_row_triling_desc": "<strong>TRILING:</strong> Vrednost tri iste kockice + 20.",
        ...
        "rules_row_poker_desc": "<strong>POKER:</strong> Vrednost četiri iste kockice + 40.",
        "rules_row_yamb_desc": "<strong>YAMB:</strong> Vrednost pet istih kockica + 50.",
        ...
        "rules_tourney_fee_text": "Prijava košta 5500 dukata. Odjava i povraćaj mogući su samo dok traje faza prijave, pre početka turnira.",
        ...
        "rules_tourney_rewards_text": "Pobednik dobija 44.000 dukata, veliki rast <strong>Indeksa Moći (PI)</strong> i upis u Dvoranu Slavnih. Finalista koji izgubi finale dobija povraćaj uloga od 5500 dukata.",

        "rules_league_title": "KVARTALNA LIGA 🏅",
        "rules_league_concept_title": "KONCEPT LIGE",
        "rules_league_concept_text": "Kvartalna liga traje 3 kalendarska meseca po vremenu Beograda. Konačni rezultat svake regularno završene solo, AI, lokalne ili online partije dodaje se Vašem ligaškom zbiru. Tehnički ishod dodaje obračunatu nagradu pobedniku, a poraženom oduzima obračunati iznos do najmanje 0.",
        "rules_league_ranks_title": "RANGOVI",
        "rules_league_ranks_text": "Rangovi su: <strong>Amater 0-4.999, Profi 5.000-14.999, Majstor 15.000-49.999, Legenda 50.000-99.999 i Titan od 100.000 poena</strong> u trenutnom kvartalu.",
        "rules_league_rewards_title": "KRAJ SEZONE I DVORANA SLAVNIH",
        "rules_league_rewards_text": "Posle završnog obračuna kvartala prva tri igrača dobijaju 10.000, 5.000 i 2.500 dukata i upisuju se u <strong>Dvoranu Slavnih</strong>. Prvoplasirani postaje Šampion ciklusa, poeni prelaze u 'Sva Vremena', a novi kvartal kreće od nule.",
        ...
        "tourney_coming_soon": "Turniri stižu uskoro!",
        ...
        "tourney_badge_open": "Turnir prima prijave",
        "tourney_badge_action": "Turnirski meč čeka vašu akciju",
        "tourney_badge_waiting": "U turniru ste i čekate druge",
        "tourney_reminder_ready": "Vaš turnirski meč je dogovoren.",
        "tourney_reminder_open": "Otvorite turnir da pokrenete meč.",
        "tourney_reminder_pending_accept": "Protivnik je predložio termin za turnirski meč.",
        "tourney_reminder_open_accept": "Otvorite turnir da prihvatite ili predložite drugo vreme.",
        "tourney_reminder_waiting": "Prijavljeni ste za turnir i čekate odgovor protivnika.",
        "tourney_reminder_open_change": "Možete otvoriti turnir i promeniti predlog termina.",
        "tourney_reminder_schedule": "Prijavljeni ste za turnir. Vaš meč čeka zakazivanje.",
        "tourney_reminder_open_schedule": "Otvorite turnir i zakažite termin sa ovim igračem.",
        "tourney_duel_pending_notice": "Poziv za turnirski meč je poslat igraču {0}. Čekamo odgovor...",
        "tourney_duel_declined_notice": "{0} je odbio turnirski meč. Dogovorite novi trenutak i pokušajte ponovo.",
        "tourney_duel_busy_notice": "{0} je trenutno zauzet. Pokušajte ponovo kasnije.",
        "tourney_duel_expired_notice": "{0} nije odgovorio na vreme. Meč nije pokrenut.",
        ...
        "tourney_final_ceremony_winner_title": "ŠAMPION TURNIRA",
        "tourney_final_ceremony_runnerup_title": "FINALISTA TURNIRA",
        "tourney_final_ceremony_winner_msg": "Čestitamo! Osvojili ste turnir.",
        "tourney_final_ceremony_runnerup_msg": "Čestitamo na učešću u finalu.",
        "tourney_final_ceremony_winner_kicker": "Velika nagrada",
        "tourney_final_ceremony_runnerup_kicker": "Utešna nagrada",
        "tourney_final_ceremony_score": "Tvoj rezultat",
        ...
        "tourney_schedule_new_time": "Zakaži novi termin",
        "tourney_draw_waiting_replay": "Meč čeka ponavljanje.",
        "tourney_draws_before_win": "Remija pre pobede",
        "tourney_result": "Rezultat",
        "tourney_technical_quit": "napuštanje",
        "tourney_technical_timeout": "istek vremena",
        "tourney_technical_disconnect": "prekid veze",
        "tourney_technical_opponent_dq": "diskvalifikacija protivnika",
        "tourney_technical_default": "tehnički",
        "tourney_tab_fame": "OSVAJAČI",
        "tourney_hall_of_fame": "OSVAJAČI TURNIRA",
        "tourney_no_champs_yet": "Još uvek nema osvajača turnira.",
        "tourney_champion_journey_title": "PUT DO TITULE",
        "tourney_champion_all_matches": "Bracket turnira",
        "tourney_champion_no_path": "Put ovog turnira nije sačuvan.",
        "tourney_champion_titles": "Osvojeni turniri",
        "tourney_champion_latest_final": "Poslednje finale",
        "tourney_champion_pick_title": "Izaberi titulu",
        "tourney_champion_journey_btn": "Put do titule",
        "tourney_share_card": "Podeli karticu",
        "tourney_share_aria": "Podeli karticu osvajača turnira",
        "tourney_share_title": "Yamb osvajač turnira",
        "tourney_share_text": "Moja Yamb kartica osvajača turnira: {0}.",
        "tourney_share_generating": "Priprema...",
        "tourney_share_fallback": "Deljenje slike nije dostupno na ovom uređaju. PNG kartica je pripremljena za preuzimanje.",
        "tourney_share_update_required": "Za deljenje slike potrebno je ažurirati aplikaciju na najnoviju verziju.",
        "tourney_share_error": "Nije moguće pripremiti sliku za deljenje.",
        "tourney_edition_suffix": "TURNIR",
        "tourney_finished_title": "Turnir je završen",
        "tourney_finished_desc": "Turnir je završen. Rezultati, bracket i put do titule ostaju sačuvani.",
        "tourney_next_registration_in": "Nove prijave",
        "tourney_next_registration_soon": "uskoro",
        ...
        "ws_hof_no_results": "Još uvek nema rezultata za ovaj period.",
        "ws_friends_title": "TVOJI PRIJATELJI",
        "friends_empty": "Još nema prijatelja.",
        ...
        "timeout_technical_win_msg": "Protivniku je isteklo vreme. Tehnička pobeda.",
        ...
        "technical_win_fled": "Tehnička pobeda. {0} je napustio partiju.",
        "technical_loss_winner": "Tehnički poraz. Pobednik je {0}.",
    ...
    en: {
        ...
        "splash_terms_and": "and",
        "splash_privacy_link": "Privacy Policy",
        "push_channel_name": "Yamb notifications",
        "push_channel_desc": "Tournament, record, and Quarterly League notifications",
        "push_open_prompt": "Open notification?",
        "push_open": "Open",
        "push_later": "Later",
        ...
        "league_champion_title": "QUARTERLY LEAGUE CHAMPION",
        ...
        "shop_unlock": "Unlock:",
        "shop_watch_to_unlock": "Watch 📺 to unlock",
        ...
        "local_game_sync_required": "The game cannot start until the server confirms that its result can be saved securely. Check your connection and try again.",
        ...
        "aria_close_h2h": "Close H2H statistics",
        "aria_close_power_index": "Close Power Index leaderboard",
        "aria_close_streak": "Close Hot Streak leaderboard",
        "economy_tabs_aria": "Ducat and undo options",
        "treasury_tabs_aria": "Treasury categories",
        ...
        "err_spectate_already_in_game": "You are already in an online game. To watch another match, open an account that is not participating in that match.",
        "err_spectate_open_failed": "Unable to open spectating for this match. Refresh the online list and try again.",
        ...
        "err_matchmaking_busy": "You already have an active online match or a pending duel recovery. Return to it or leave it before starting a new search.",
        ...
        "game_roll": "ROLL",
        "game_wait": "WAIT...",
        "game_returning": "Returning to the game...",
        "game_write": "WRITE",
        ...
        "global_chat_loading": "Loading messages...",
        "global_chat_empty": "No messages yet. Start the conversation.",
        ...
        "go_title_solo_rough": "NOT YOUR DAY",
        "go_title_solo_more": "ROOM TO IMPROVE",
        "go_title_solo_progress": "NICE PROGRESS",
        "go_title_solo_good": "GOOD GAME",
        "go_title_solo_masterful": "MASTERFUL GAME",
        "go_title_solo_perfect": "PERFECTION",
        "go_msg_win": "Winner is",
        "go_msg_solo": "SCORE",
        "go_personal_best": "PERSONAL BEST",
        "go_label_your_score": "YOUR SCORE",
        "go_best_column": "BEST COLUMN",
        "go_no_zero": "NO ZEROES",
        "go_yes": "YES",
        "go_no": "NO",
        ...
        "go_msg_solo_rough": "It was not your game this time. The next board is a new chance — {0} points.",
        "go_msg_solo_more": "A solid start, but you can do more. Score: {0} points.",
        "go_msg_solo_progress": "The progress is clear. Keep going — {0} points.",
        "go_msg_solo_good": "A steady, good game. You scored {0} points.",
        "go_msg_solo_masterful": "Excellent control of the board — {0} points.",
        "go_msg_solo_perfect": "A top-level game. {0} points — one to remember.",
        ...
        "go_double_easter": "DOUBLE REWARD (x2)",
        "go_claim": "Claim & Exit",
        "go_rematch": "🔄 REMATCH",
        "msg_reward_doubled": "Reward successfully doubled!\nTotal won:",
        "reward_claim_retry": "The reward has not been confirmed yet. Please try again in a few seconds.",
        "ad_confirmation_retry": "The ad confirmation has not arrived yet. Try claiming the reward again in a few seconds.",
        ...
        "undo_expired": "Undo for that entry is no longer available because the next move has started.",
        "undo_unavailable": "Undo is currently unavailable.",
        "undo_menu_desc": "Get tokens to undo your moves",
        "undo_btn_ad_1": "Watch Reward Video (+1)",
        ...
        "rules_goal_text": "The goal is to score as many points as possible by rolling 6 dice and entering the best combinations into the table. Each turn gives you up to 3 rolls, and after every roll you may hold dice you want to keep.",
        ...
        "rules_col_man": "<strong>HAND (R):</strong> Scores only after the first roll. If you continue, the field is entered as 0 after confirmation.",
        "rules_col_ann": "<strong>ANNOUNCE (📢):</strong> After the first roll, you may enable Announce, select the exact field, and then you must fill that field.",
        ...
        "rules_sec2_text": "Formula: (Max - Min) * number of ones. If the result is ≥ 60, bonus is +40. If MIN is 0 or the calculation is negative, the section scores 0.",
        "rules_sec3_title": "3. SECTION (COMBINATIONS)",
        "rules_row_triling_desc": "<strong>3 of a Kind:</strong> Value of the three matching dice + 20.",
        ...
        "rules_row_poker_desc": "<strong>4 of a Kind:</strong> Value of the four matching dice + 40.",
        "rules_row_yamb_desc": "<strong>YAMB:</strong> Value of the five matching dice + 50.",
        ...
        "rules_tourney_fee_text": "Registration costs 5500 ducats. Unregistering and refunds are possible only during registration, before the tournament starts.",
        ...
        "rules_tourney_rewards_text": "The winner receives 44,000 ducats, a major <strong>Power Index (PI)</strong> boost, and a Hall of Fame entry. The finalist who loses the final gets the 5500 ducat entry fee refunded.",

        "rules_league_title": "QUARTERLY LEAGUE 🏅",
        "rules_league_concept_title": "LEAGUE CONCEPT",
        "rules_league_concept_text": "The Quarterly League lasts 3 calendar months in Belgrade time. Your final score from every regularly completed solo, AI, local, or online game is added to your league total. A technical result adds the calculated reward to the winner and deducts the calculated amount from the loser, down to 0.",
        "rules_league_ranks_title": "RANKS",
        "rules_league_ranks_text": "The ranks are: <strong>Amateur 0-4,999, Pro 5,000-14,999, Master 15,000-49,999, Legend 50,000-99,999, and Titan from 100,000 points</strong> in the current quarter.",
        "rules_league_rewards_title": "END OF SEASON & HALL OF FAME",
        "rules_league_rewards_text": "After the quarter's final settlement, the top three players receive 10,000, 5,000, and 2,500 ducats and enter the <strong>Hall of Fame</strong>. First place becomes the Cycle Champion, points move to All-Time, and the new quarter starts from zero.",
        ...
        "tourney_coming_soon": "Tournaments are coming soon!",
        ...
        "tourney_badge_open": "Tournament registration is open",
        "tourney_badge_action": "Your tournament match needs your action",
        "tourney_badge_waiting": "You are in the tournament and waiting",
        "tourney_reminder_ready": "Your tournament match has been scheduled.",
        "tourney_reminder_open": "Open the tournament to start the match.",
        "tourney_reminder_pending_accept": "Your opponent proposed a time for the tournament match.",
        "tourney_reminder_open_accept": "Open the tournament to accept or propose another time.",
        "tourney_reminder_waiting": "You are registered for the tournament and waiting for your opponent's response.",
        "tourney_reminder_open_change": "You can open the tournament and change your proposed time.",
        "tourney_reminder_schedule": "You are registered for the tournament. Your match is waiting to be scheduled.",
        "tourney_reminder_open_schedule": "Open the tournament and schedule a time with this player.",
        "tourney_duel_pending_notice": "Tournament match invitation sent to {0}. Waiting for a response...",
        "tourney_duel_declined_notice": "{0} declined the tournament match. Agree on another moment and try again.",
        "tourney_duel_busy_notice": "{0} is currently busy. Please try again later.",
        "tourney_duel_expired_notice": "{0} did not respond in time. The match was not started.",
        ...
        "tourney_final_ceremony_winner_title": "TOURNAMENT CHAMPION",
        "tourney_final_ceremony_runnerup_title": "TOURNAMENT FINALIST",
        "tourney_final_ceremony_winner_msg": "Congratulations! You won the tournament.",
        "tourney_final_ceremony_runnerup_msg": "Congratulations on reaching the final.",
        "tourney_final_ceremony_winner_kicker": "Grand prize",
        "tourney_final_ceremony_runnerup_kicker": "Runner-up reward",
        "tourney_final_ceremony_score": "Your score",
        ...
        "tourney_schedule_new_time": "Schedule new time",
        "tourney_draw_waiting_replay": "This match is waiting for a replay.",
        "tourney_draws_before_win": "Draws before win",
        "tourney_result": "Result",
        "tourney_technical_quit": "quit",
        "tourney_technical_timeout": "timeout",
        "tourney_technical_disconnect": "disconnect",
        "tourney_technical_opponent_dq": "opponent disqualification",
        "tourney_technical_default": "technical",
        "tourney_tab_fame": "CHAMPIONS",
        "tourney_hall_of_fame": "TOURNAMENT CHAMPIONS",
        "tourney_no_champs_yet": "There are no tournament champions yet.",
        "tourney_champion_journey_title": "TITLE RUN",
        "tourney_champion_all_matches": "Tournament bracket",
        "tourney_champion_no_path": "This tournament path was not saved.",
        "tourney_champion_titles": "Tournament wins",
        "tourney_champion_latest_final": "Latest final",
        "tourney_champion_pick_title": "Choose title",
        "tourney_champion_journey_btn": "Title run",
        "tourney_share_card": "Share card",
        "tourney_share_aria": "Share tournament champion card",
        "tourney_share_title": "Yamb tournament champion",
        "tourney_share_text": "My Yamb tournament champion card: {0}.",
        "tourney_share_generating": "Preparing...",
        "tourney_share_fallback": "Image sharing is not available on this device. The PNG card has been prepared for download.",
        "tourney_share_update_required": "Image sharing requires updating the app to the latest version.",
        "tourney_share_error": "Could not prepare the image for sharing.",
        "tourney_edition_suffix": "TOURNAMENT",
        "tourney_finished_title": "Tournament finished",
        "tourney_finished_desc": "The tournament is finished. Results, bracket, and title run remain saved.",
        "tourney_next_registration_in": "New registrations",
        "tourney_next_registration_soon": "soon",
        ...
        "ws_hof_no_results": "There are no results for this period yet.",
        ...
        "timeout_technical_win_msg": "Opponent ran out of time. Technical victory.",
        ...
        "technical_win_fled": "Technical victory. {0} left the game.",
        "technical_loss_winner": "Technical defeat. The winner is {0}.",
...
function applyTranslations() {
    const activeLanguage = localStorage.getItem('yamb_lang') === 'en' ? 'en' : 'sr';

    ...
    const renderPlayersState = (state, text) => {
        ...
        body.innerHTML = `
            <div class="online-players-state ${state === 'loading' ? 'is-loading' : ''}" data-online-state="${sec.escapeAttr(state)}">
                <img class="online-players-state-soft-clay-icon" src="assets/easter-soft-clay/online-players-state-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async">
                <img class="online-players-state-soft-clay-icon-desert" src="assets/desert-soft-clay/online-players-state-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async">
                <img class="online-players-state-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-players-state-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async">
        ...
        const bindOnlinePlayersList = () => {
            ...
            visiblePlayers.forEach(p => {
                ...
                if (!isMe) {
                    ...
                    let addFriendBtn = '';
                    if (isAlreadyFriend) {
                        addFriendBtn = `<button class="online-player-action online-player-action--friend is-disabled" disabled title="${sec.escapeAttr(alreadyFriendTitle)}" style="width: 38px; height: 38px; border-radius: 8px; font-size: 1.1rem; display: flex; align-items: center; justify-content: center; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); color: gray; cursor: not-allowed; opacity: 0.4;"><span class="online-player-action-fallback" aria-hidden="true">➕</span><img class="online-player-action-soft-clay-icon" src="assets/easter-soft-clay/online-add-friend-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-desert" src="assets/desert-soft-clay/online-add-friend-pro.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-add-friend-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"></button>`;
                    } else {
                        // Dodata logika da se dugme "ugasi" čim se klikne da bi se izbegao spam
                        addFriendBtn = `<button class="online-player-action online-player-action--friend" onclick="${addFriendHandler}" title="${sec.escapeAttr(addFriendTitle)}" style="width: 38px; height: 38px; border-radius: 8px; font-size: 1.1rem; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: transform 0.1s; background: rgba(76, 175, 80, 0.2); border: 1px solid var(--success); color: white;" onmousedown="this.style.transform='scale(0.9)'" onmouseup="this.style.transform='scale(1)'"><span class="online-player-action-fallback" aria-hidden="true">➕</span><img class="online-player-action-soft-clay-icon" src="assets/easter-soft-clay/online-add-friend-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-desert" src="assets/desert-soft-clay/online-add-friend-pro.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-add-friend-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"></button>`;
                    }
                    ...
                    if (!canSpectate) {
                        ...
                        spectateBtn = `<button class="online-player-action online-player-action--spectate is-disabled" disabled title="${sec.escapeAttr(spectateTitle)}" style="width: 38px; height: 38px; border-radius: 8px; font-size: 1.3rem; display: flex; align-items: center; justify-content: center; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255,0.1); color: gray; cursor: not-allowed; opacity: 0.4;"><span class="online-player-action-fallback" aria-hidden="true">👁️</span><img class="online-player-action-soft-clay-icon" src="assets/easter-soft-clay/online-spectate-pro-v4.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-desert" src="assets/desert-soft-clay/online-spectate-pro.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-spectate-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"></button>`;
                    } else {
                        spectateBtn = `<button class="online-player-action online-player-action--spectate" onclick="${spectateHandler}" title="${sec.escapeAttr(spectateTitleText)}" style="width: 38px; height: 38px; border-radius: 8px; font-size: 1.3rem; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: transform 0.1s; background: rgba(33, 150, 243, 0.2); border: 1px solid #2196F3; color: white;" onmousedown="this.style.transform='scale(0.9)'" onmouseup="this.style.transform='scale(1)'"><span class="online-player-action-fallback" aria-hidden="true">👁️</span><img class="online-player-action-soft-clay-icon" src="assets/easter-soft-clay/online-spectate-pro-v4.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-desert" src="assets/desert-soft-clay/online-spectate-pro.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-spectate-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"></button>`;
                    }

                    let challengeBtn = '';
                    if (isBusy) {
                        challengeBtn = `<button class="online-player-action online-player-action--duel is-disabled" disabled title="${sec.escapeAttr(playerBusyTitle)}" style="width: 38px; height: 38px; border-radius: 8px; font-size: 1.3rem; display: flex; align-items: center; justify-content: center; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); color: gray; cursor: not-allowed; opacity: 0.4;"><span class="online-player-action-fallback" aria-hidden="true">⚔️</span><img class="online-player-action-soft-clay-icon" src="assets/easter-soft-clay/online-duel-pro-v3.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-desert" src="assets/desert-soft-clay/online-duel-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-duel-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"></button>`;
                    } else {
                        challengeBtn = `<button class="online-player-action online-player-action--duel" onclick="${challengeHandler}" title="${sec.escapeAttr(challengeTitleText)}" style="width: 38px; height: 38px; border-radius: 8px; font-size: 1.3rem; display: flex; align-items: center; justify-content: center; cursor: pointer; transition: transform 0.1s; background: rgba(244, 67, 54, 0.2); border: 1px solid var(--danger); color: white;" onmousedown="this.style.transform='scale(0.9)'" onmouseup="this.style.transform='scale(1)'"><span class="online-player-action-fallback" aria-hidden="true">⚔️</span><img class="online-player-action-soft-clay-icon" src="assets/easter-soft-clay/online-duel-pro-v3.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-desert" src="assets/desert-soft-clay/online-duel-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"><img class="online-player-action-soft-clay-icon-nebula" src="assets/severna-soft-clay/online-duel-pro-v2.png?v=1" alt="" aria-hidden="true" decoding="async"></button>`;
                    }

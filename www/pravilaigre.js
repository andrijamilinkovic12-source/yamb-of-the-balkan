    ...
    sr: [
        {
            ...
            content: `
                ...
                <h3>${rulesThemeGlyphIconHtml(rulesIconHtml('menu-icon-stats'), 'assets/easter-soft-clay/statistics-pro.png?v=1')} Kolone u igri</h3>
                <ul>
                ...
                <h3>${rulesThemeGlyphIconHtml(rulesIconHtml('menu-icon-leaderboard'), 'assets/easter-soft-clay/leaderboard-pro.png?v=1')} Bodovanje i sekcije</h3>
                <h4>1. SEKCIJA (1-6)</h4>
        ...
        },
        {
            ...
            content: `
                ...
                <h3>${rulesThemeAssetIconHtml('assets/leaderboard-icon.svg', 'assets/easter-soft-clay/leaderboard-pro.png?v=1')} Top liste i rangiranje</h3>
                <ul>
        ...
        },
        {
            ...
            content: `
                ...
                <h3>${rulesThemeAssetIconHtml('assets/tournament-info-icon.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Turniri</h3>
                <ul>
                    <li><strong>${rulesThemeAssetIconHtml('assets/tournament-icon.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Sistem:</strong> Nedeljni turnir prima 8 igrača i igra se na ispadanje: četvrtfinale, polufinale i finale. Svaki duel je jedna partija.</li>
                    ...
                    <li><strong>${rulesThemeAssetIconHtml('assets/tournament-trophy-yotb.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Nagrade:</strong> Pobednik dobija 44.000 dukata, veliki rast Indeksa moći i ${rulesThemeAssetIconHtml('assets/tournament-hall-icon.svg', 'assets/easter-soft-clay/tournament/tab-hall-of-fame.png?v=1')} upis u Dvoranu slavnih. Finalista koji izgubi finale dobija povraćaj uloga od 5500 dukata.</li>
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    ...
                    <li><strong>${rulesThemeAssetIconHtml('assets/daily-challenge-icon.svg', 'assets/easter-soft-clay/daily-challenge-pro.png?v=1')} Dnevni izazov:</strong> Dnevna nagrada je dostupna jednom dnevno. Server određuje kockice: prve 4 se sabiraju, 5. kockica množi taj zbir, a 6. množi ceo rezultat. Nagrada se može duplirati reklamom.</li>
                    ...
                    <li><strong>${rulesThemeAssetIconHtml('assets/tournament-trophy-yotb.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Takmičenja:</strong> Turniri i Kvartalna liga donose najveće nagrade najboljim igračima.</li>
                </ul>
                ...
                <h3>${rulesThemeAssetIconHtml('assets/treasury-icon.svg', 'assets/easter-soft-clay/treasury-pro.png?v=1')} Riznica</h3>
        ...
        },
        {
            ...
            content: `
                ...
                <h3>${rulesThemeGlyphIconHtml('🖥️', 'assets/easter-soft-clay/settings-pro.png?v=1')} Server podrška i bezbednost</h3>
                <ul>
    ...
    en: [
        {
            ...
            content: `
                ...
                <h3>${rulesThemeGlyphIconHtml(rulesIconHtml('menu-icon-stats'), 'assets/easter-soft-clay/statistics-pro.png?v=1')} Game Columns</h3>
                <ul>
                ...
                <h3>${rulesThemeGlyphIconHtml(rulesIconHtml('menu-icon-leaderboard'), 'assets/easter-soft-clay/leaderboard-pro.png?v=1')} Scoring & Sections</h3>
        ...
        },
        {
            ...
            content: `
                ...
                <h3>${rulesThemeAssetIconHtml('assets/leaderboard-icon.svg', 'assets/easter-soft-clay/leaderboard-pro.png?v=1')} Leaderboards</h3>
                <ul>
        ...
        },
        {
            ...
            content: `
                ...
                <h3>${rulesThemeAssetIconHtml('assets/tournament-info-icon.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Tournaments</h3>
                <ul>
                    <li><strong>${rulesThemeAssetIconHtml('assets/tournament-icon.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Format:</strong> The weekly tournament accepts 8 players and is played as a knockout bracket: quarterfinals, semifinals, and final. Each duel is one game.</li>
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    ...
                    <li><strong>${rulesThemeAssetIconHtml('assets/daily-challenge-icon.svg', 'assets/easter-soft-clay/daily-challenge-pro.png?v=1')} Daily Challenge:</strong> The daily reward is available once per day. The server sets the dice: the first 4 are summed, the 5th die multiplies that sum, and the 6th multiplies the total. The reward can be doubled with an ad.</li>
                    ...
                    <li><strong>${rulesThemeAssetIconHtml('assets/tournament-trophy-yotb.svg', 'assets/easter-soft-clay/tournament-pro.png?v=1')} Competitions:</strong> Tournaments and the Quarterly League give the largest rewards to top players.</li>
                </ul>
                ...
                <h3>${rulesThemeAssetIconHtml('assets/treasury-icon.svg', 'assets/easter-soft-clay/treasury-pro.png?v=1')} Treasury</h3>
        ...
        },
        {
            ...
            content: `
                ...
                <h3>${rulesThemeGlyphIconHtml('🖥️', 'assets/easter-soft-clay/settings-pro.png?v=1')} Server Support & Security</h3>
                <ul>

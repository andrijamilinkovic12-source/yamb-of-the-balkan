...
function rulesSevernaAssetSrc(easterSrc = '') {
    ...
    const severnaOverrides = {
        ...
        'assets/easter-soft-clay/statistics/record-v2.png': 'assets/severna-soft-clay/statistics/record-v10.png?v=1',
        'assets/easter-soft-clay/statistics/power-index-bolt-v3.png': 'assets/severna-soft-clay/statistics/power-index-bolt-v10.png?v=1',
        'assets/easter-soft-clay/statistics/wins-v2.png': 'assets/severna-soft-clay/statistics/wins-v10.png?v=1',
        'assets/easter-soft-clay/statistics/fire-streak-v2.png': 'assets/severna-soft-clay/statistics/fire-streak-v11.png?v=1',
        'assets/easter-soft-clay/statistics/all-time-points-v2.png': 'assets/severna-soft-clay/statistics/all-time-points-v11.png?v=1',
        'assets/easter-soft-clay/statistics/h2h-v2.png': 'assets/severna-soft-clay/statistics/h2h-v10.png?v=1',
        ...
        'assets/easter-soft-clay/tournament/finalist-silver-v3.png': 'assets/severna-soft-clay/tournament/finalist-silver-v3.png?v=1',
        ...
        'assets/easter-soft-clay/settings/profile-v2.png': 'assets/severna-soft-clay/settings/profile-v2.png?v=1',
        'assets/easter-soft-clay/settings/privacy-v2.png': 'assets/severna-soft-clay/settings/privacy-v2.png?v=1',
        'assets/easter-soft-clay/treasury/tab-trophies-v2.png': 'assets/severna-soft-clay/treasury/tab-trophies-v2.png?v=1',
        'assets/easter-soft-clay/treasury/tab-skins-v2.png': 'assets/severna-soft-clay/treasury/tab-skins-v2.png?v=1',
        'assets/easter-soft-clay/treasury/tab-effects-v2.png': 'assets/severna-soft-clay/treasury/tab-effects-v2.png?v=1',
        'assets/easter-soft-clay/treasury/tab-themes-v2.png': 'assets/severna-soft-clay/treasury/tab-themes-v2.png?v=1',
        'assets/easter-soft-clay/tournament/tab-hall-of-fame-v2.png': 'assets/severna-soft-clay/tournament/tab-hall-of-fame-v2.png?v=1'
    };
    ...
    sr: [
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    <li><strong>${rulesThemeGlyphIconHtml('⚡', 'assets/easter-soft-clay/statistics/power-index-bolt-v3.png?v=1')} Indeks moći (Power Index):</strong> Glavni pokazatelj uspeha koji spaja rezultate, pobede, trofeje i ligaški učinak.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('🏅', 'assets/easter-soft-clay/statistics/record-v2.png?v=1')} Rekord:</strong> Vaš najbolji lični rezultat.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('⚖️', 'assets/easter-soft-clay/statistics/wins-v2.png?v=1')} Odnos pobeda/poraza (W/L):</strong> Prikazuje efikasnost u direktnim online duelima i turnirima.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('🔥', 'assets/easter-soft-clay/statistics/fire-streak-v2.png?v=1')} Vatreni niz:</strong> Broj uzastopnih pobeda ostvarenih u duelima i turnirima.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('🌟', 'assets/easter-soft-clay/statistics/all-time-points-v2.png?v=1')} All-Time PTS:</strong> Ukupan zbir poena kroz sve završene partije.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('⚔️', 'assets/easter-soft-clay/statistics/h2h-v2.png?v=1')} Rival:</strong> Prijatelj sa kojim imate najviše odigranih međusobnih duela.</li>
                </ul>
                
                <h3>${rulesThemeGlyphIconHtml('⚔️', 'assets/easter-soft-clay/statistics/h2h-v2.png?v=1')} Međusobni dueli (H2H)</h3>
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    ...
                    <li><strong>${rulesThemeGlyphIconHtml('🎮', 'assets/easter-soft-clay/online-duel-pro-v3.png?v=1')} Duel chat:</strong> Privatni chat tokom meča sa protivnikom. I ovde važe ista pravila fer i kulturnog ponašanja.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('⚔️', 'assets/easter-soft-clay/online-duel-pro-v3.png?v=1')} Izazov iz chata:</strong> Klikom na ime igrača u globalnom chatu možete ga direktno izazvati.</li>
                </ul>
            `
        },
        {
        ...
        },
        {
            ...
            content: `
                <h3>${rulesThemeGlyphIconHtml('🔐', 'assets/easter-soft-clay/settings/profile-v2.png?v=1')} Google integracija i cloud čuvanje</h3>
                ...
                <h4>${rulesThemeGlyphIconHtml('🛡️', 'assets/easter-soft-clay/settings/privacy-v2.png?v=1')} Koji podaci se prikupljaju i zašto?</h4>
    ...
    en: [
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    <li><strong>${rulesThemeGlyphIconHtml('⚡', 'assets/easter-soft-clay/statistics/power-index-bolt-v3.png?v=1')} Power Index:</strong> The main success indicator, combining results, wins, trophies, and league performance.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('🏅', 'assets/easter-soft-clay/statistics/record-v2.png?v=1')} High score:</strong> Your personal best score.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('⚖️', 'assets/easter-soft-clay/statistics/wins-v2.png?v=1')} W/L Ratio:</strong> Shows your efficiency in direct online duels and tournaments.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('🔥', 'assets/easter-soft-clay/statistics/fire-streak-v2.png?v=1')} Win Streak:</strong> Number of consecutive wins in duels and tournaments.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('🌟', 'assets/easter-soft-clay/statistics/all-time-points-v2.png?v=1')} All-Time PTS:</strong> Total points across all finished games.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('⚔️', 'assets/easter-soft-clay/statistics/h2h-v2.png?v=1')} Rival:</strong> The friend you have played against the most.</li>
                </ul>
                
                <h3>${rulesThemeGlyphIconHtml('⚔️', 'assets/easter-soft-clay/statistics/h2h-v2.png?v=1')} Head-to-Head (H2H)</h3>
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    ...
                    <li><strong>${rulesThemeAssetIconHtml('assets/tournament-trophy-yotb.svg', 'assets/easter-soft-clay/tournament-pro-v3.png?v=1')} Rewards:</strong> The winner receives 44,000 ducats, a major Power Index boost, and a ${rulesThemeAssetIconHtml('assets/tournament-hall-icon.svg', 'assets/easter-soft-clay/tournament/tab-hall-of-fame-v2.png?v=1')} Hall of Fame entry. The finalist who loses the final gets the 5500 ducat entry fee refunded.</li>
        ...
        },
        {
            ...
            content: `
                ...
                <ul>
                    ...
                    <li><strong>${rulesThemeGlyphIconHtml('🎮', 'assets/easter-soft-clay/online-duel-pro-v3.png?v=1')} Duel Chat:</strong> Private chat during a match with your opponent. The same fair-play rules apply.</li>
                    <li><strong>${rulesThemeGlyphIconHtml('⚔️', 'assets/easter-soft-clay/online-duel-pro-v3.png?v=1')} Chat challenge:</strong> Clicking a player's name in global chat can challenge that player directly.</li>
                </ul>
            `
        },
        {
        ...
        },
        {
            ...
            content: `
                <h3>${rulesThemeGlyphIconHtml('🔐', 'assets/easter-soft-clay/settings/profile-v2.png?v=1')} Google Integration & Cloud Save</h3>
                ...
                <h4>${rulesThemeGlyphIconHtml('🛡️', 'assets/easter-soft-clay/settings/privacy-v2.png?v=1')} What data is collected and why?</h4>
